...
class DefaultApi {
  ...
  Future<Response<AdminAccountsGet200Response>> adminAccountsGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (pageNum != null) r'page_num': encodeQueryParameter(_serializers, pageNum, const FullType(int)),
  ...
  Future<Response<JsonObject>> imgReaderCoversBookIdGet({ 
    ...
    final _path = r'/img/reader/covers/{book_id}'.replaceAll('{' r'book_id' '}', encodeQueryParameter(_serializers, bookId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<EbookListDto>> readerFavGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (pageNum != null) r'page_num': encodeQueryParameter(_serializers, pageNum, const FullType(num)),
      if (category != null) r'category': encodeQueryParameter(_serializers, category, const FullType(String)),
      if (author != null) r'author': encodeQueryParameter(_serializers, author, const FullType(String)),
    };
  ...
  Future<Response<EbookIndexDto>> readerIndexGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (random != null) r'random': encodeQueryParameter(_serializers, random, const FullType(num)),
      if (recent != null) r'recent': encodeQueryParameter(_serializers, recent, const FullType(num)),
    };
