...
class DefaultApi {
  ...
  Future<Response<AdminAccountsGet200Response>> adminAccountsGet({
    ...
    AdminAccountsGet200Response? _responseData;
    ...
    return Response<AdminAccountsGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserDto>> adminAccountsPost({
    ...
    try {
      ...
      _bodyData = createUserDto == null
          ? null
          : _serializers.serialize(createUserDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<UserDto>> adminAccountsUserIdGet({
    ...
    final _path = r'/admin/accounts/{user_id}'.replaceAll(
        '{' r'user_id' '}',
  ...
  Future<Response<BuiltList<ApikeyDto>>> authAccountsAccountIdApikeysGet({
    ...
    BuiltList<ApikeyDto>? _responseData;
    ...
    return Response<BuiltList<ApikeyDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApikeyDto>> authAccountsAccountIdApikeysPost({
    ...
    try {
      ...
      _bodyData = authAccountsAccountIdApikeysPostRequest == null
          ? null
          : _serializers.serialize(authAccountsAccountIdApikeysPostRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<RespDto>> authAccountsAccountIdResetPost({
    ...
    try {
      ...
      _bodyData = changePasswordDto == null
          ? null
  ...
  Future<Response<RespDto>> authLoginPost({
    ...
    try {
      ...
      _bodyData = loginCredentialDto == null
          ? null
          : _serializers.serialize(loginCredentialDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> imgReaderCoversBookIdGet({
    ...
    final _path = r'/img/reader/covers/{book_id}'.replaceAll(
        '{' r'book_id' '}',
  ...
  Future<Response<JsonObject>> m4tTtsSimplePost({
    ...
    try {
      ...
      _bodyData = m4tTtsStreamPostRequest == null
          ? null
          : _serializers.serialize(m4tTtsStreamPostRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<SpeakerListDto>> m4tTtsSpeakersGet({
    ...
    final _path = r'/m4t/tts/speakers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<SpeakerListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<EbookDto>> readerBooksBookIdGet({
    ...
    final _path = r'/reader/books/{book_id}'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<EbookDto>> readerBooksBookIdPut({
    ...
    try {
      ...
      _bodyData = readerBooksBookIdPutRequest == null
          ? null
          : _serializers.serialize(readerBooksBookIdPutRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<EbookListDto>> readerBooksGet({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (author != null)
        r'author':
            encodeQueryParameter(_serializers, author, const FullType(String)),
    };
  ...
  Future<Response<JsonObject>> readerDownloadBooksBookIdGet({
    ...
    final _path = r'/reader/download/books/{book_id}'.replaceAll(
        '{' r'book_id' '}',
        encodeQueryParameter(_serializers, bookId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<EbookListDto>> readerFavGet({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (pageNum != null)
        r'page_num':
            encodeQueryParameter(_serializers, pageNum, const FullType(num)),
      if (category != null)
        r'category': encodeQueryParameter(
            _serializers, category, const FullType(String)),
      if (author != null)
  ...
  Future<Response<EbookIndexDto>> readerIndexGet({
    ...
    final _queryParameters = <String, dynamic>{
      if (random != null)
        r'random':
            encodeQueryParameter(_serializers, random, const FullType(num)),
      if (recent != null)
        r'recent':
            encodeQueryParameter(_serializers, recent, const FullType(num)),
    };
  ...
  Future<Response<ReaderStatsDto>> readerStatsGet({
    ...
    return Response<ReaderStatsDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SysInfoDto>> sysInfoPut({
    ...
    try {
      ...
      _bodyData = sysInfoDto == null
          ? null
          : _serializers.serialize(sysInfoDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<SysPingGet200Response>> sysPingGet({
    ...
    SysPingGet200Response? _responseData;
    ...
    return Response<SysPingGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ScanStatsDto>> sysScanRunPost({
    ...
    try {
      ...
      _bodyData = enableScanDto == null
          ? null
          : _serializers.serialize(enableScanDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
