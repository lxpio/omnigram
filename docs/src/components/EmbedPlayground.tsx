...
export default function EmbedPlayground() {
  const [host, setHost] = useState("https://omnigram.lxpio.com")
  ...
  return (
    <div>
      <div className="input-group">
        ...
        <div className="grid">
          <button className="button button--outline button--secondary" onClick={() => setHost("https://omnigram.lxpio.com")}>Main</button>
          <button className="button button--outline button--secondary" onClick={() => setHost("https://preview.omnigram.lxpio.com")}>Preview</button>
          <button className="button button--outline button--secondary" onClick={() => setHost("https://v1.omnigram.lxpio.com")}>V1</button>
          <button className="button button--outline button--secondary" onClick={() => setHost("https://v2.omnigram.lxpio.com")}>V2</button>
        </div>
      </div>
