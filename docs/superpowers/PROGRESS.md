...
| ├─ AI 数据完全隔离 | §8.2 | ✅ | 独立 DB 天然隔离 | Phase 1 |
| └─ 快速锁定 + 卸载策略 | §10.4 | ✅ | `stealth_home.dart` LifecycleObserver + Keychain 清理 | `00af249` |
...
| Plan 2 · Now-Playing UX | ⏳ | Mini Bar + 全屏 Now-Playing + Pill + Pill detail sheet（待开工） |
