...
class Locales {
  static const zh_CN = {
    ...
    'chat_gpt_help':
        '在使用之前,您需要做一个简单的配置。\n\n1. 点击我的头像,进入我的主页;\n2. 填写您的API Key。\n\n如果您还没有申请API Key,请在我的主页点击[获取帮助](https://www.exppii.com/omnigram/help/chat_gpt.html)来查看如何申请。',
    'chat_gpt_help_url': 'https: //www.exppii.com/omnigram/help/chat_gpt.html',
  ...
  static const en_US = {
    ...
    'chat_gpt_help':
        'You need to make a simple configuration for me before using it.\n1. click on my avatar, go to my home page;\n2. fill in your API Key.\n\nIf you haven\'t applied for an API Key, please click [Get Help](https://www.exppii.com/omnigram/help/chat_gpt.html) on my home page to see how to apply.',
    'chat_gpt_help_url': 'https: //www.exppii.com/omnigram/help/chat_gpt.html',
